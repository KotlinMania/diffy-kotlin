...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Diffy.swiftmodule/`
...
//      `import Diffy` above would fail at compile time.
//
//   2. The static archive `libDiffy.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Diffy" }` and
//      `flattenPackage = "io.github.kotlinmania.diffy"` configuration in
