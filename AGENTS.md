...
This file is the quick-reference operating contract for diffy-kotlin. The longer
...
diffy-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`diffy`](https://crates.io/crates/diffy). Upstream Rust is the behavioral oracle while the
