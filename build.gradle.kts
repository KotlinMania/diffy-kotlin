...
kotlin {
    ...
    val xcf = XCFramework("Diffy")

    macosArm64 {
        binaries.framework { baseName = "Diffy"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Diffy"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Diffy"
        flattenPackage = "io.github.kotlinmania.diffy"
    }

    android {
        namespace = "io.github.kotlinmania.diffy"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "diffy-kotlin", version.toString())

    pom {
        name.set("diffy-kotlin")
        description.set("Kotlin Multiplatform port of bmwill/diffy - Tools for finding and manipulating differences between files")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/diffy-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/diffy-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/diffy-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/diffy-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.diffy.codeql
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleDiffyXCFramework",
    "assembleDiffyDebugXCFramework",
    "assembleDiffyReleaseXCFramework",
    "assembleDebugIosFatFrameworkForDiffyXCFramework",
    "assembleReleaseIosFatFrameworkForDiffyXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForDiffyXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForDiffyXCFramework",
    "assembleDebugMacosFatFrameworkForDiffyXCFramework",
    "assembleReleaseMacosFatFrameworkForDiffyXCFramework",
    "assembleDebugTvosFatFrameworkForDiffyXCFramework",
    "assembleReleaseTvosFatFrameworkForDiffyXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForDiffyXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForDiffyXCFramework",
    "assembleDebugWatchosFatFrameworkForDiffyXCFramework",
    "assembleReleaseWatchosFatFrameworkForDiffyXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForDiffyXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForDiffyXCFramework",
